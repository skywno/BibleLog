...
from common.models import FAITH_REACTIONS, FaithReaction, NoteReactions, ReactionCount
from social_service.repositories.social import SocialRepository


class SocialService:
    def __init__(self, social: SocialRepository, event_bus: KafkaEventBus) -> None:
        self._social = social
